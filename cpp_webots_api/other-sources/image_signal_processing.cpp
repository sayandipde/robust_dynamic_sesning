...
Mat imageSignalProcessing::approximate_pipeline(Mat the_img_vrep, int the_pipe_version) { 
  ...
  // save_images
  string out_string = "/home/yingkai/yingkai-huang3/Approx_IBC/final_app/cpp/cpp_vrep_api/out_imgs";
...
Mat imageSignalProcessing::run_pipeline(bool direction, Mat the_img_in, int the_pipe_version) {
  ...
  char cam_model_path[] = 
  "/home/yingkai/yingkai-huang3/Approx_IBC/final_app/cpp/ReversiblePipeline/src/Halide/camera_models/NikonD7000/";
