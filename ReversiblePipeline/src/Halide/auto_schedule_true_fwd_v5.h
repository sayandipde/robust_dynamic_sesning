#ifndef HALIDE_____auto_schedule_true_fwd_v5_h
#define HALIDE_____auto_schedule_true_fwd_v5_h
#include <stdint.h>
...
int auto_schedule_true_fwd_v5(struct halide_buffer_t *_in_patch_buffer, struct halide_buffer_t *_ctrl_pts_h_buffer, struct halide_buffer_t *_weights_h_buffer, struct halide_buffer_t *_rev_tone_h_buffer, struct halide_buffer_t *_TsTw_tran_h_buffer, struct halide_buffer_t *_coefs_h_buffer, struct halide_buffer_t *_processed_buffer) HALIDE_FUNCTION_ATTRS;
int auto_schedule_true_fwd_v5_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *auto_schedule_true_fwd_v5_metadata() HALIDE_FUNCTION_ATTRS;
